...
const translations = {
    uz: {
        ...
        hero_subtitle: " MCHJ",
        hero_description_1: "Biz yuqori sifatli qurilish xizmatlarini taqdim etamiz. Loyihalaringizni professional jamoamiz bilan amalga oshiring.",
        hero_description_2: "Bizning tajribali mutaxassislar jamoasi loyihangizni o'z vaqtida va yuqori sifatda bajaradi.",
        hero_description_3: "Innovatsion yechimlar va zamonaviy texnologiyalar yordamida qurilishning yangi darajasini kashf eting.",
        ...
        about_description: "Biz qurilish sohasida 20 yildan ortiq tajribaga ega yetakchi kompaniyamiz. Bizning maqsadimiz mijozlarimizning umidlaridan oshib ketadigan yuqori sifatli loyihalarni yetkazib berishdir.",
        ...
        services_description: "Biz sizning ehtiyojlaringizni qondirish uchun keng ko'lamli qurilish xizmatlarini taklif qilamiz.",
        ...
        service_2_description: "Loyihani muammosiz amalga oshirish va yetkazib berishni ta'minlash uchun mutaxassis boshqaruv.",
        ...
        testimonial_1_quote: "\"O'ztemiryo'lqurilishmontaj jamoasi loyihamizni o'z vaqtida topshirdi va umidlarimizdan oshib ketdi. Juda tavsiya qilaman!\"",
        testimonial_1_author: "John Doe",
        testimonial_1_position: "ABC Corp direktori",
        testimonial_2_quote: "\"Ularning tafsilotlarga e'tibor berishi va professionalligi butun jarayonni muammosiz qildi. Ajoyib ish!\"",
    ...
    ru: {
        ...
        hero_subtitle: " МЧЖ",
        hero_description_1: "Мы предоставляем высококачественные строительные услуги. Реализуйте свои проекты с нашей профессиональной командой.",
        hero_description_2: "Наша команда опытных специалистов выполнит ваш проект вовремя и с высоким качеством.",
        hero_description_3: "Откройте новый уровень строительства с инновационными решениями и современными технологиями.",
        ...
        about_title: "О нас",
        about_description: "Мы — ведущая компания с более чем 20-летним опытом в строительной отрасли. Наша цель — поставлять высококачественные проекты, превосходящие ожидания наших клиентов.",
        ...
        testimonial_1_quote: "\"Команда Узтемирйулкурилишмонтаж сдала наш проект вовремя и превзошла наши ожидания. Очень рекомендую!\"",
        testimonial_1_author: "Джон Доу",
        testimonial_1_position: "Директор ABC Corp",
        testimonial_2_quote: "\"Их внимание к деталям и профессионализм сделали весь процесс беспроблемным. Отличная работа!\"",
